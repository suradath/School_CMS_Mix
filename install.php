...
/**
 * School CMS Mix V2.4 Installer - Modern Edition
 */
...
<head>
    ...
    <title>School CMS Mix V2.4 Installer - Modern Setup</title>
...
<body class="flex items-center justify-center min-h-screen p-6">
    <div class="max-w-2xl w-full">
        ...
        <div class="flex flex-col items-center mb-10">
            ...
            <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight">School CMS Mix V2.4</h1>
            ...
            <div class="p-10 md:p-12">
                ...
                <?php elseif($step === 3): ?>
                    <div class="text-center mb-10">
                        ...
                        <p class="text-slate-400">ขั้นตอนสุดท้ายในการเริ่มต้นระบบ School CMS Mix V2.4</p>
                    </div>
                ...
                <?php elseif($step === 4): ?>
                    <div class="text-center py-10">
                        ...
                        <p class="text-slate-400 mb-10 max-w-sm mx-auto">ระบบ School CMS Mix V2.4 พร้อมใช้งานแล้ว กรุณาลบไฟล์ install.php ออกจากเซิร์ฟเวอร์เพื่อความปลอดภัย</p>
        ...
        <p class="text-center mt-10 text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em] opacity-50">
            &copy; <?= date('Y') ?> School CMS Mix V2.4 Application
        </p>
    </div>
