<div class="mb-6 flex justify-between items-center text-right">
    <a href="/personnel/create" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition shadow-md">
                ...
                <div class="flex p-5">
                    <div class="flex-shrink-0 mr-4">
                        <img class="w-16 h-16 rounded-full object-cover border-2 border-blue-100" 
                             src="<?= $person['image_url'] ?: 'https://ui-avatars.com/api/?name='.urlencode($person['name']).'&background=random' ?>" 
                             alt="<?= $person['name'] ?>">
                    </div>
                    <div>
                        ...
                        <div class="mt-3 flex space-x-2">
                            <a href="/personnel/edit/<?= $person['id'] ?>" class="text-xs bg-gray-50 text-gray-600 px-2 py-1 rounded hover:bg-gray-100 transition">แก้ไข</a>
                            <a href="/personnel/delete/<?= $person['id'] ?>" class="text-xs bg-red-50 text-red-600 px-2 py-1 rounded hover:bg-red-100 transition" onclick="return confirm('ยืนยันการลบ?')">ลบ</a>
                        </div>
                    </div>
                </div>
            </div>
