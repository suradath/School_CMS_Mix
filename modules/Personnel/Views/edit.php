<div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-8">
        <form action="<?= url('/personnel/update/' . $person['id']) ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-4 text-center">
                    <div>
                        ...
                        <div class="flex flex-col items-center">
                            <img class="w-32 h-32 rounded-full object-cover border-4 border-blue-50 mb-4 bg-gray-50" src="<?= $person['image_url'] ? url($person['image_url']) : 'https://ui-avatars.com/api/?name='.urlencode($person['name']).'&background=random' ?>" alt="">
