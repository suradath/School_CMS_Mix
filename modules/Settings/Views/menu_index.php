<div class="mb-8 flex justify-between items-center">
    ...
    <a href="/settings/menu/create" class="bg-primary hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-2xl transition shadow-lg shadow-blue-500/20 flex items-center">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td class="px-8 py-6 text-right">
                        <div class="flex justify-end space-x-2">
                            <a href="/settings/menu/edit/<?= $menu['id'] ?>" class="p-2 text-slate-400 hover:text-primary hover:bg-primary/10 rounded-xl transition-all">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                            </a>
                            <a href="/settings/menu/delete/<?= $menu['id'] ?>" onclick="return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบเมนูนี้?')" class="p-2 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all">
