...
<head>
    ...
    <title>เข้าสู่ระบบ - School CMS Mix V2.7</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="bg-blue-700 p-6 text-white text-center">
            <h1 class="text-2xl font-bold">School CMS Mix V2.7</h1>
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-100 text-center">
            <p class="text-xs text-gray-500">&copy; 2026 School CMS Mix V2.7. All rights reserved.</p>
        </div>
    </div>
</body>
