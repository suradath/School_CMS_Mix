<div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-8">
        <form action="/news/store" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" required class="bg-gray-50 border border-gray-300 text-gray-900 font-bold text-lg rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-4 transition" placeholder="เช่น การประชุมผู้ปกครองภาคเรียนที่ 1/2567">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">รายละเอียดข่าว</label>
                        <textarea name="content" rows="12" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-4 transition" placeholder="ระบุรายละเอียดของข่าวสารกิจกรรมที่นี่..."></textarea>
                    </div>
                </div>
                    ...
                    <div class="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="published_at" value="<?= date('Y-m-d\TH:i') ?>" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                        </div>
                    </div>
